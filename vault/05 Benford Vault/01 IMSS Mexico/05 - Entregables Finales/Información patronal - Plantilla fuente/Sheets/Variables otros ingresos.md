...
Hoja de detalle de variables relacionadas con otros ingresos.

## Fila candidata de encabezados
- No identificada con suficiente confianza

## Campos detectados preliminarmente
- Pendiente de extraer con mejor precisión

## Contexto visible alrededor de encabezados
- Fila 2: A=Instituto Mexicano del Seguro Social
- Fila 3: A=Dictamen para efectos del Seguro Social Información Patronal: Cédula de análisis de otros ingresos por salario
- Fila 4: B=Detalle de conceptos sobre otros ingresos por salario
- Fila 5: A=Consecutivo | B=Conceptos considerados en otros ingresos por salario | C=Importe considerado en otros ingresos por salarios que fueron variables del sexto bimestre anterior al ejercicio dictaminado | D=Importe considerado en otros ingresos por salarios que fueron variables del sexto bimestre del ejercicio dictaminado
- Fila 6: A=1
- Fila 7: A=2 | B=Totales

## Variables o labels repetidos detectados
...
- nómina
- cédulas de variables
- papeles de trabajo de separación o bajas

## Transformaciones previas probables
- clasificación de conceptos variables
- depuración por periodo
- consolidación por trabajador o evento
