#!/usr/bin/env python3
"""
Genera el snapshot JSON del Benford Vault y lo inyecta en dashboard/index.html.
...
Outputs:
  dashboard/vault_snapshot.json     (snapshot crudo, gitignored)
  dashboard/index.html              (con el snapshot reinyectado)

Uso:
  python3 dashboard/build_snapshot.py
  python3 dashboard/build_snapshot.py --vault-root "/path/to/Benford Vault V3"
  BENFORD_VAULT_ROOT="..." python3 dashboard/build_snapshot.py
"""
...
SNAPSHOT_OUT = SCRIPT_DIR / "vault_snapshot.json"
ARTIFACT_HTML = SCRIPT_DIR / "index.html"
