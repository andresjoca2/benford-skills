...
description: >-
  Orquesta automatizaciones por colas de propuestas PROP-* en Benford Vault V3.
  Usala cuando el usuario quiera detectar nuevas propuestas, correr triggers por
  carpeta, observar 02 Proposals, rutear Drafts, o continuar con la siguiente
  skill segun la cola: Router Engine, decision humana, Canonical Editor u otros
...
Esta skill coordina triggers por cola. No reemplaza a las skills de trabajo; las
dispara o reporta que estan listas.
...
2. Resuelve `vaultRoot` igual que el Router: `BENFORD_VAULT_ROOT`,
   ...
   Vault.
3. Ejecuta `check` para ver conteos por cola.
