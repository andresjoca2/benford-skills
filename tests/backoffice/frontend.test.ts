...
describe("clo backoffice frontend", () => {
  ...
  test("wires the company rerun button to campaign run creation", async () => {
    ...
    expect(screen).toContain("reviewPersonCandidate(person.candidateId, status, text || undefined)")
    ...
    expect(devServer).toContain("companyPeopleRunMatch")
    expect(devServer).toContain("people-runs")
    expect(devServer).toContain("createPeopleRunForCompanyCandidate")
